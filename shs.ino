...
void shsInitialize() {
  ...
  block1->addSwitch('1',  3, "Fan", "Fan in the bedr room");
  block1->addSwitch('1',  3, "Fan", "Fan in the bedr room");
  ...
  block2->addSwitch('1',  7, "Fan 1", "Main fan in the hall just above the sofa");

  Block* block3 = Block :: addBlock("Block 3", "Contains the third set of 12 Switches..");
  block3->addSwitch('1',  8, "Fan 2", "Main fan in the hall before stairs");
  block3->addSwitch('1', 14, "Socket 1", "Triple way plug socket in hall near sofa");
  block3->addSwitch('1', 15, "Socket 2", "Triple way plug socket in the bedroom");
  block3->addSwitch('1', 16, "Socket 3", "Triple way plug socket for heavey use");
  block3->addSwitch('1', 17, "Socket 4", "Triple way plug socket in the kichen");
  block3->addSwitch('1', 18, "Water Motor", "Will pump the water from ground tank to top tank");
